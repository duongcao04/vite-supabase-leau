...
import LeauLogoImg from '../../assets/logo.png'
  ...
  return (
    <Wrapper>
      <div className="flex items-center justify-start gap-2">
        <img
          src={logoTheme === 'light' ? LeauLogoImg : LeauLogoImg}
          alt="CSD Logo"
          className={cn(
            'object-contain w-20',
            classNames?.logo,
        ...
        <div>
          <p
            className={cn(
              'font-quicksand text-6xl font-black text-text-default',
              classNames?.appName,
            )}
          >
            Leau
