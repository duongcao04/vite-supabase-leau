      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-[#1B365D]">
            [cite_start]Customer Portal, Knowledge Centre, and Product ID App
            [cite: 42]
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border-t-4 border-[#F37021] hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-slate-600 mb-6 text-sm leading-relaxed">
              [cite_start]Our Customer Portal provides customers with access to
              our Knowledge Centre, where you can find installation guides and
              troubleshooting resources[cite: 47]. The portal also includes the
              ability to save favourite products and resources.
            </p>
            <div className="mt-auto flex gap-4">
              ...
              >
                [cite_start]Sign In [cite: 49] <ArrowRight size={16} />
              </a>
              <a
                href="/about-portal"
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border-t-4 border-[#1B365D] hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-slate-600 mb-6 text-sm leading-relaxed">
              ...
              providing in-depth technical information. [cite_start]It features
              detailed blog posts, comprehensive manuals, and expert
              guides[cite: 50, 51].
            </p>
            <a
            ...
            >
              [cite_start]View Knowledge Centre [cite: 52]{' '}
              <ArrowRight size={16} />
            </a>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border-t-4 border-[#F37021] hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-slate-600 mb-6 text-sm leading-relaxed">
              [cite_start]It is your complete solution for accessing detailed
              information about our custom-built products, including the Bermad
              400 & 700 Series Control Valves and Backflow Meter Assembly
              Pipestands[cite: 53].
            </p>
            <div className="mt-auto flex gap-4">
              <a
                ...
                className="text-[#F37021] font-bold text-sm hover:underline flex items-center gap-1"
              >
                [cite_start]View Demo [cite: 60] <ArrowRight size={16} />
              </a>
              <a
                href="/app-info"
                className="text-slate-500 font-semibold text-sm hover:text-[#1B365D]"
