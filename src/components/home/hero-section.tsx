   ...
   <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 z-10 relative bg-primary">
    ...
    <div className="relative">
     <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
      Advanced <span className="text-[#F37021]">Water Process</span> Solutions
     </h1>
     <p className="text-lg text-slate-300 mb-8 max-w-lg leading-relaxed">
      From industrial waterworks to precision irrigation and fire protection, we
      provide the critical components that keep Aotearoa flowing.
     </p>
     <div className="flex flex-wrap gap-4">
      ...
      <Link
       ...
       className="px-8 py-4 bg-transparent border-2 border-slate-400 hover:border-white text-white/80! hover:text-white! font-bold rounded transition-colors"
      >
       Contact Us
      </Link>
     </div>
