...
import IsoValveLogo from '../../ui/isovalve-logo' // Adjust path as needed
   ...
   <div className="container mx-auto py-4 flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    <div className="flex items-center gap-6 text-primary">
     ...
     >
      ...
      <span className="font-semibold text-lg hidden lg:inline">Sign In</span>
     </Link>
     <Link
      to="/support"
      className="flex items-center gap-2 hover:opacity-80 transition-opacity"
     >
      ...
      <span className="font-semibold text-lg hidden lg:inline">Support</span>
     </Link>
    </div>
   </div>
