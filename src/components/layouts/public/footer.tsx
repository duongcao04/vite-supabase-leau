...
import IsoValveLogo from '../../ui/isovalve-logo'
...
export function Footer() {
 return (
  <footer className="pt-32">
   <OceanWaves />
   <div className="w-full bg-linear-180 from-primary via-primary-200 to-primary-50 pt-14 pb-44 text-text-default">
    ...
    <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
     ...
     <div className="lg:col-span-1">
      ...
      <div className="mb-4">
       <p className="font-bold text-sm">Customer Success & Technical Support</p>
       <a
        href="mailto:hey@isovalve.app"
      ...
      <div className="mb-6">
       ...
       <a
        href="mailto:orders@isovalve.app"
        className="text-sm text-slate-600 hover:text-orange-500"
       >
        orders@isovalve.app
       </a>
